...
[AddComponentMenu("Util/Perlin Noise")]
public static class Noise {
    ...
    public static float GetNoise(double pX, double pY, double pZ) {
        ...
        //A step of (1,0,0) in (i,j,k) means a step of (1-c,-c,-c) in (x,y,z), a step of (0,1,0) in (i,j,k) means a step of (-c,1-c,-c) in (x,y,z), and
        ...
        //Add contributions from each corner to get the final noise value. The result is scaled to stay just inside [-1, 1] - now [0, 1]
